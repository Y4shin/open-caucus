...
export const file_conference_attendees_v1_attendees: GenFile = /*@__PURE__*/
  fileDesc("", [file_conference_common_v1_common]);
...
/**
 * @generated from message conference.attendees.v1.InviteSecretJoinRequest
 */
export type InviteSecretJoinRequest = Message<"conference.attendees.v1.InviteSecretJoinRequest"> & {
  /**
   * @generated from field: string committee_slug = 1;
   */
  committeeSlug: string;
  ...
  /**
   * @generated from field: string invite_secret = 3;
   */
  inviteSecret: string;
};

/**
 * Describes the message conference.attendees.v1.InviteSecretJoinRequest.
 * Use `create(InviteSecretJoinRequestSchema)` to create a new message.
 */
export const InviteSecretJoinRequestSchema: GenMessage<InviteSecretJoinRequest> = /*@__PURE__*/
  messageDesc(file_conference_attendees_v1_attendees, 20);

/**
 * @generated from message conference.attendees.v1.InviteSecretJoinResponse
 */
export type InviteSecretJoinResponse = Message<"conference.attendees.v1.InviteSecretJoinResponse"> & {
  /**
   * @generated from field: string attendee_secret = 1;
   */
  attendeeSecret: string;
...
/**
 * Describes the message conference.attendees.v1.InviteSecretJoinResponse.
 * Use `create(InviteSecretJoinResponseSchema)` to create a new message.
 */
export const InviteSecretJoinResponseSchema: GenMessage<InviteSecretJoinResponse> = /*@__PURE__*/
  messageDesc(file_conference_attendees_v1_attendees, 21);
...
export const AttendeeService: GenService<{
   ...
   *
   * @generated from rpc conference.attendees.v1.AttendeeService.InviteSecretJoin
   */
  inviteSecretJoin: {
    methodKind: "unary";
    input: typeof InviteSecretJoinRequestSchema;
    output: typeof InviteSecretJoinResponseSchema;
  },
}> = /*@__PURE__*/
