...
export type SendInviteEmailsRequest = Message<"conference.committees.v1.SendInviteEmailsRequest"> & {
  ...
  /**
   * optional personal message from chairperson
   *
   * @generated from field: string custom_message = 5;
   */
  customMessage: string;

  /**
   * "en" or "de"; empty = default (en)
   *
  ...
  /**
   * IANA timezone for datetime display, e.g. "Europe/Berlin"; empty = UTC
   *
